...
{
   public class EMNDBMapper
    {
        public EMNNoteList Map_EMNNoteList(DataRow dr)
        {
            EMNNoteList result = new EMNNoteList();
            try
            {
                if (dr != null)
                {
        ...
        public EMNHeader Map_EMNHeader(DataRow dr)
        {
        ...
        public EMNTravellingPerson Map_EMNTravellingPerson(DataRow dr)
        {
            EMNTravellingPerson result = new EMNTravellingPerson();
            try
            {
                if (dr != null)
                {
        ...
        public EMNTravellingDetails Map_EMNTravellingDetails(DataRow dr)
        {
        ...
        public EMNDateWiseTour Map_EMNDateWiseTour(DataRow dr)
        {
            EMNDateWiseTour result = new EMNDateWiseTour();
            try
            {
                if (dr != null)
                {
